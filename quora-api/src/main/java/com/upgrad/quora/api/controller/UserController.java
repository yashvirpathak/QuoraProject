...
public class UserController {
    ...
    public ResponseEntity<SignupUserResponse> signup(final SignupUserRequest signupUserRequest) throws SignUpRestrictedException {
        ...
        final UserEntity signedupUser = userBusinessService.signup(userEntity);

        SignupUserResponse userResponse = new SignupUserResponse().id(signedupUser.getUuid()).status("USER SUCCESSFULLY REGISTERED");
    ...
    public ResponseEntity<SignoutResponse> signout(@RequestHeader("authorization") final String authorization) throws SignOutRestrictedException {
        ...
        UserEntity signedOutUser = userBusinessService.signout(authorization);
